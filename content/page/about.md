...
_**First author**_
    ...
    - By rAAV-miniBEND mediated **CCM modeling**, we establish a platform for therapeutic drug screen. 
    - By rAAV-miniBEND mediated **bAVM modeling**, we identified that Braf-MEK1 signaling is sufficient to trigger bAVM onset. 
    - By rAAV-miniBEND mediated **bAVM modeling** and **snRNAseq analysis**, we discovered key pathways and genes involved in bAVM progression. We identified that venous endothelial cells (vECs) is the most relevant endothelial cell subpopulation responsible for bAVM formation. 
