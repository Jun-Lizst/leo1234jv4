...
I would like to highlight six publications demonstrating my scientific contributions, my expertise in molecular dissection, genetic perturbation, and system-level analysis, and that reflect my commitment to building mechanistic clarity in complex biological contexts.
...
_**First author**_
    - **Our rAAV-miniBEND system** provides a widely applicable tool for local or global brainEC gene delivery.
    - By rAAV-miniBEND, we further demonstrate that endothelial overexpression of MAP3K3 disease mutant (I441M) is sufficient to induce rapid and spatially defined CCM pathogenesis, providing a mechanistically defined and scalable platform for therapeutic target validation and drug screening.
    - By rAAV-miniBEND, we demonstrate that activation of **BRAF–MEK1 signaling** in brain endothelial cells is sufficient to initiate and drive the onset and progression of brain arteriovenous malformations (bAVMs). 
    - By rAAV-miniBEND mediated **bAVM modeling** and **snRNAseq analysis**, we discovered key pathways and genes involved in bAVM progression, and identified that venous endothelial cells (vECs) is the most relevant endothelial cell subpopulation responsible for bAVM formation. 
    - Our work **establishes a causal link** between a defined signaling pathway and vascular malformation in vivo, providing both a versatile tool for mechanistic studies and a framework for modeling disease initiation in a physiologically relevant context.
...
2. Huanhuan Pang#, ***Jun-Liszt Li#*** &para;, Xiaoling Hu, Fei Chen, Xiaofei Gao, Lauren Zacharias, Ralph Deberardinis, Wenzhi Sun✝, Zeping Hu✝, Woo-Ping Ge✝  "Precision mapping of the mouse brain metabolome." **BioRxiv** **(28/12/2020)** [[PDF](https://pkueducn-my.sharepoint.com/:b:/g/personal/lijun0705_pku_edu_cn/EU-xBTRDra9Nq5ii6XGPA1sBb5L2IG1T4OkFt5M27uIAFQ?e=Znk6ct) | [Shiny app](https://leoj.shinyapps.io/BSMAv1_updated/) | [DOI Link](https://doi.org/10.1101/2020.12.28.424544)]  _**Co-first author**_
    - We are one of the early pioneers for method development of spatial metabolomics.
...
4. Xiaofei Gao#, Xing-jun Chen#, Meng Ye, ***Jun-Liszt Li*** &para;, Nannan Lu, Di Yao, Bo Ci, Fei Chen, Lijun Zheng, Yating Yi, Shiwen Zhang, Zhanying Bi, Xinwei Gao, Yuanlei Yue, Tingbo Li, Jiafu Lin, Ying-Chao Shi, Kaibin Shi, Nicholas E. Propson, Yubin Huang, Katherine Poinsatte, Zhaohuan Zhang, Dale B. Bosco, Shi-bing Yang, Ralf H. Adams, Volkhard Lindner, Fen Huang, Long-Jun Wu, Hui Zheng, Simon Hippenmeyer, Ann M. Stowe, Bo Peng, Marta Margeta, Qingchun Guo, Xiaoqun Wang, Qiang Liu, Jakob Körbelin, Martin Trepel, Hui Lu, Guoen Cai, Bo O. Zhou, Bo Shen, Ying-mei Lu, Wenzhi Sun, Jie-Min Jia, Feng Han, Hu Zhao, Robert M. Bachoo & Woo-ping Ge✝ "Reduction of neuronal activity mediated by blood-vessel regression in the adult brain." **Nature Communications** **(01/07/2025)** [[PDF](https://www.nature.com/articles/s41467-025-60308-0.pdf) | [PMID: 40595484](https://pubmed.ncbi.nlm.nih.gov/40595484/) | [DOI Link](https://doi.org/10.1038/s41467-025-60308-0)]
    ...
    - By Creating a brain-endothelial cell specific Cre driver line, **Slco1c1-KI-iCreERT2**, we use mouse genetics to provide evidences supporting that TAK1 is necessary to maintain the stability of Neurovascular unit (NVU) in the adult brain.
