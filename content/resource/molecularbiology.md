...
- **NO**:
    - geNOps: novel multicoloured fluorescent quenching-based  probes by fusing a bacteria-derived -binding domain close to distinct fluorescent protein variants. [[PMID: 26842907](https://pubmed.ncbi.nlm.nih.gov/26842907/) | [DOI Link](https://doi.org/10.1038/ncomms10623)]
- **ONOO-**:
    - pnGFP-Ultra: pnGFP-Ultra exhibits high selectivity and sensitivity toward peroxynitrite with an ~110-fold turn-on response. [[PMID: 33581056](https://pubmed.ncbi.nlm.nih.gov/33581056/) | [DOI Link](https://doi.org/10.1016/j.chembiol.2021.01.013)]
- **Formaldehyde (FA)**: 
    - FAsors: HxlR-based FA sensors, FA-responsive transcription factor HxlR from Bacillus subtilis, which shows that HxlR recognizes FA through an intra-helical cysteine-lysine crosslinking reaction at its N-terminal helix α1, leading to conformational change and transcriptional activation. [[PMID: 33495458](https://pubmed.ncbi.nlm.nih.gov/33495458/) | [DOI Link](https://doi.org/10.1038/s41467-020-20754-4)]
...
4. [Bianxiao Cui Lab, Stanford](https://cuilab.stanford.edu/)
...
- **MagR(_ISCA1_)**
    - Long, X., Ye, J., Zhao, D. & Zhang, S.-J. Magnetogenetics: remote non-invasive magnetic activation of neuronal activity with a magnetoreceptor. Sci Bull (Beijing) 60, 2107–2119 (2015). [[PMID: 26740890](https://pubmed.ncbi.nlm.nih.gov/26740890/) | [DOI Link](http://dx.doi.org/10.1007/s11434-015-0902-0)]

- **TRPV4-P2A-ferritin**
    - Wheeler, M. A. et al. Genetically targeted magnetic control of the nervous system. Nat Neurosci 19, 756–761 (2016). [[PMID: 26950006](https://pubmed.ncbi.nlm.nih.gov/26950006/) | [DOI Link](https://doi.org/10.1038/nn.4265)]
...
- **ferritins**: When isolated from cells and loaded with iron in vitro, these crystals generate magnetic forces that are 9 orders of magnitude larger than the forces from the single ferritin cages used in previous studies. 
    - Li, T. L. et al. Engineering a Genetically Encoded Magnetic Protein Crystal. Nano Lett 19, 6955–6963 (2019). [[PMID: 31552740](https://pubmed.ncbi.nlm.nih.gov/31552740/) | [DOI Link](https://doi.org/10.1021/acs.nanolett.9b02266)]
     


## Ref Labs
1. [Sheng-Jia Zhang Lab, Xinqiao Hospital, China](https://www.researchgate.net/scientific-contributions/Sheng-Jia-Zhang-38282418)
2. [Bianxiao Cui Lab, Stanford](https://cuilab.stanford.edu/)
...
1. [PSORT](http://psort.nibb.ac.jp/)：By amino acid composition information and sorting signal knowledge

2. [TargetP2.0](https://services.healthtech.dtu.dk/service.php?TargetP-2.0)：TargetP-2.0
...
3. [MitoProt](http://ihg.gsf.de/ihg/mitoprot.html)：By discriminating mitochondrial and chloroplast signal peptide

4. [Predotar](http://www.inra.fr/Internet/Produits/Predotar/): By discriminating mitochondrial, chloroplast signal peptide
...
5. [NNPSL](http://predict.sanger.ac.uk/nnpsl)：By amino acid composition   

6. [SobLoc](http://www.bioinfo.tsinghua.edu.cn/SubLoc/)：By amino acid composition   
    - **By more sequence information besides the amino acid composition**\
[ ] Nair, Rajesh, and Burkhard Rost. "Better prediction of sub‐cellular localization by combining evolutionary and structural information." Proteins: Structure, Function, and Bioinformatics 53.4 (2003): 917-930. [[DOI Link](https://doi.org/10.1002/prot.10507)]

7. [SignalP 5.0](): SignalP 5.0 is a deep neural network–based method combined with conditional random field that distinguishes between various types of SPs across all domains of life and between three kinds of prokaryotic SPs (Sec/SPI, Sec/SPII, and Tat/SPI).
[PMID: 30778233](https://pubmed.ncbi.nlm.nih.gov/30778233/)

8. [DeepLoc 1.0](https://services.healthtech.dtu.dk/service.php?DeepLoc-1.0): uses a deep learning architecture very similar to what we have used in this study to predict the subcellular localisation of proteins. [[DeepLoc 2.0](https://services.healthtech.dtu.dk/service.php?DeepLoc-2.0)]
- Almagro Armenteros, José Juan, et al. "DeepLoc: prediction of protein subcellular localization using deep learning." Bioinformatics 33.21 (2017): 3387-3395. [[PMID: 29036616](https://pubmed.ncbi.nlm.nih.gov/29036616/) | [DOI Link](https://doi.org/10.1093/bioinformatics/btx431)]
